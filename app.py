...
""".format(otp)
    ...
    server.login('mbmanu2000@gmail.com', 'yffarslpkxzgncib')
    server.sendmail('mbmanu2000@gmail.com', to_email, msg.as_string())
    server.quit()
...
def send_new_course_email( email_content):
    email_address = 'mbmanu2000@gmail.com'  # Your Gmail email address
    app_password = 'yffarslpkxzgncib'  # Your app-specific password

    to_email = 'mehulnaik16@gmail.com'  # Recipient's email address
...
def start_npm():
    try:
        ...
        frontend_project_path = r'server/server.js'
